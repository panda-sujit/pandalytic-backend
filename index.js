...
app.use(function (req, res, next) {
  ...
  res.setHeader("Access-Control-Allow-Headers", "X-Requested-With,Access-Control-Allow-Headers,content-type,x-auth-token,Authorization,Content-Type,application/json");
